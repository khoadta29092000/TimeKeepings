...
const breadcrumbIcons = () => {
    const data = [
        ...
        { title: 'Monthly In Out', icon: <BadgeIcon />, url: '/Report', status: false },
    ]
    return data
}
...
export default function MonthlyInOutAttendance() {
    return (
        <div className="">
            <div className="px-12 py-6">
                <h2 className="font-bold text-3xl mb-4">Monthly In Out</h2>
